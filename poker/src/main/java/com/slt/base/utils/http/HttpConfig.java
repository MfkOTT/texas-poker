...
public class HttpConfig {
	...
	protected HttpURLConnection getConnection(URL url, String method, String ctype,Map<String,String> headMap) throws IOException {
	...
	protected Map<String, Object> getResponseAsByteArray(HttpURLConnection conn) throws IOException {
		...
		try {
			...
			if (StringUtils.isEmpty(ctype)) {
				throw new IOException("指定下载的文件类型不能为空");
			} else {
